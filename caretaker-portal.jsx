      ...
      <div style={{ maxWidth: 420, margin: '0 auto', padding: '0 16px 100px', minHeight: '100vh' }}>
        <div style={{ padding: '12px 0 8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            <button onClick={function() { setHash(''); }} title={verzorgendeNaam} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, display: 'flex', alignItems: 'center' }}>
              <div style={{ width: 28, height: 28, borderRadius: 14, background: C.achtergrond, border: '1px solid ' + C.border, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 700, color: C.tekstSecundair }}>{profiel.initialen}</div>
            </button>
          </div>
        </div>
        <div style={{ marginBottom: 12 }}><WeergaveSwitcher /></div>
