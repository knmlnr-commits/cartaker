...
window.uiVertalingen = {
  ...
  // ── CareTaker Light ──
  caretakerPortal: { nl: 'CareTaker Portal', en: 'CareTaker Portal' },
  snelConsultInschieten: { nl: 'Snel consult inschieten', en: 'Quick consult submission' },
  nieuwConsult: { nl: 'Nieuw consult aanmaken', en: 'Create new consult' },
  lopendeConsults: { nl: 'Lopende consults', en: 'Active consults' },
  hoofdapp: { nl: 'Hoofdapp', en: 'Main app' },
  zoekOpGeboortedatum: { nl: 'Zoek bewoner op geboortedatum', en: 'Find resident by date of birth' },
  geboortedatum: { nl: 'Geboortedatum', en: 'Date of birth' },
  gevonden: { nl: 'Gevonden', en: 'Found' },
  geenBewoner: { nl: 'Geen bewoner gevonden met deze geboortedatum', en: 'No resident found with this date of birth' },
  watVoorMelding: { nl: 'Wat voor melding?', en: 'What type of report?' },
  nietSpoed: { nl: 'Niet-spoed', en: 'Non-urgent' },
  nietSpoedUitleg: { nl: 'Schouwen, medicatievraag, planbare zaken', en: 'Viewing, medication question, plannable matters' },
  mogelijkeSpoed: { nl: 'Mogelijke spoed', en: 'Possible emergency' },
  mogelijkeSpoedUitleg: { nl: 'NTS triage bij acute klachten', en: 'NTS triage for acute complaints' },
  beschrijfKlacht: { nl: 'Beschrijf kort wat er aan de hand is', en: 'Briefly describe what is going on' },
  klachtCategorie: { nl: 'Categorie', en: 'Category' },
  schouwen: { nl: 'Schouwen na overlijden', en: 'Viewing after death' },
  medicatievraag: { nl: 'Medicatievraag', en: 'Medication question' },
  valIncident: { nl: 'Val incident', en: 'Fall incident' },
  huidWond: { nl: 'Huid / wond', en: 'Skin / wound' },
  gedragOnrust: { nl: 'Gedrag / onrust', en: 'Behavior / agitation' },
  overigNietSpoed: { nl: 'Overig', en: 'Other' },
  consultIngediend: { nl: 'Consult ingediend', en: 'Consult submitted' },
  wachtenOpVideo: { nl: 'Wachten op videogesprek', en: 'Waiting for video call' },
  artsBeltU: { nl: 'De arts belt u wanneer het consult beoordeeld is', en: 'The doctor will call you when the consult is assessed' },
  simuleerGesprek: { nl: 'Simuleer inkomend gesprek', en: 'Simulate incoming call' },
  inkomendGesprek: { nl: 'Inkomend videogesprek', en: 'Incoming video call' },
  accepteren: { nl: 'Accepteren', en: 'Accept' },
  weigeren: { nl: 'Weigeren', en: 'Decline' },
  inGesprek: { nl: 'In gesprek', en: 'In call' },
  gesprekBeeindigen: { nl: 'Gesprek be\u00EBindigen', en: 'End call' },
  verstuurAanvraag: { nl: 'Verstuur', en: 'Submit' },
  extraToelichting: { nl: 'Extra toelichting, vitalen, observaties...', en: 'Additional details, vitals, observations...' },
  statusHistorie: { nl: 'Statushistorie', en: 'Status history' },
  aanvullen: { nl: 'Aanvullen', en: 'Add info' },
  videocall: { nl: 'Videocall', en: 'Video call' },
  artsOnderweg: { nl: 'Arts onderweg', en: 'Doctor en route' },
  inBehandeling: { nl: 'In behandeling', en: 'In progress' },
  wachtend: { nl: 'Wachtend', en: 'Waiting' },
  afgerond: { nl: 'Afgerond', en: 'Completed' },
  annuleren: { nl: 'Annuleren', en: 'Cancel' },
